...
#ifndef CPU_JIT_AVX512_CORE_I8I8_extract_image_patches_HPP
#define CPU_JIT_AVX512_CORE_I8I8_extract_image_patches_HPP
...
struct jit_avx512_core_i8i8_extract_img_patches_fwd_ker_t;

struct jit_avx512_core_i8i8_extract_image_patches_fwd_t : public cpu_primitive_t {
...
private:
    ...
    jit_avx512_core_i8i8_extract_img_patches_fwd_ker_t *ker_;
};
