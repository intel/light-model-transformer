...
#ifndef CPU_JIT_UNI_extract_image_patches_HPP
#define CPU_JIT_UNI_extract_image_patches_HPP
...
struct jit_uni_extract_image_patches_fwd_t: public cpu_primitive_t {
    struct pd_t: public cpu_extract_image_patches_fwd_pd_t {
        ...
        DECLARE_COMMON_PD_T(
                ...
                jit_uni_extract_image_patches_fwd_t<isa>);
        ...
        virtual status_t init() override {
            ...
            return jit_uni_extract_img_patches_kernel_f32<isa>::init_conf(jpp_, desc_,
        ...
        jit_extract_img_patches_conf_t jpp_;
    ...
    jit_uni_extract_image_patches_fwd_t(const pd_t *pd, const input_vector &inputs,
            const output_vector &outputs)
        : cpu_primitive_t(&conf_, inputs, outputs), conf_(*pd)
    { kernel_ = new jit_uni_extract_img_patches_kernel_f32<isa>(conf_.jpp_); }

    ~jit_uni_extract_image_patches_fwd_t() { delete kernel_; }
...
//    void execute_forward_3d();
    pd_t conf_;
    jit_uni_extract_img_patches_kernel_f32<isa> *kernel_;
};
