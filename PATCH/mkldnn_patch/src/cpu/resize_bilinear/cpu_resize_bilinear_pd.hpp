...
inline data_type_t resize_bilinear_index_data_type(const resize_bilinear_desc_t *p) {
...
struct cpu_resize_bilinear_fwd_pd_t: public resize_bilinear_fwd_pd_t {
    ...
    cpu_resize_bilinear_fwd_pd_t(engine_t *engine, const resize_bilinear_desc_t *adesc,
            const primitive_attr_t *attr, const resize_bilinear_fwd_pd_t *hint_fwd_pd)
        : resize_bilinear_fwd_pd_t(engine, adesc, attr, hint_fwd_pd)
        , src_pd_(engine_, &desc_.src_desc), dst_pd_(engine_, &desc_.dst_desc)
        , ws_pd_(engine_) {}
    virtual ~cpu_resize_bilinear_fwd_pd_t() {}
