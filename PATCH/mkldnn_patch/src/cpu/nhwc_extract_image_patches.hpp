...
#ifndef CPU_NHWC_extract_image_patches_HPP
#define CPU_NHWC_extract_image_patches_HPP
...
struct nhwc_extract_image_patches_fwd_t: public cpu_primitive_t {
    struct pd_t: public cpu_extract_image_patches_fwd_pd_t {
        ...
        DECLARE_COMMON_PD_T("nhwc_extract_image_patches:any", nhwc_extract_image_patches_fwd_t);
            ...
            if (is_training) {
                ...
                if (is_3d()) {
                    ...
                    mkldnn_memory_desc_init(&indices_desc, 5, ws_dims,
                            extract_image_patches_index_data_type(desc()),
                            memory_format::ndhwc);
#endif
                } else {
    ...
    nhwc_extract_image_patches_fwd_t(const pd_t *pd, const input_vector &inputs,
