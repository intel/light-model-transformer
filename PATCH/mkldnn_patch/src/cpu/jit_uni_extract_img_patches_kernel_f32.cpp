...
template <cpu_isa_t isa>
inline void jit_uni_extract_img_patches_kernel_f32<isa>::max_step_fwd(int ur_w, int pad_l,
        int pad_r) {
    int iw = jpp.iw;
    int kw = jpp.kw;
...
template <cpu_isa_t isa>
void jit_uni_extract_img_patches_kernel_f32<isa>::maybe_zero_diff_src() {
...
template <cpu_isa_t isa>
void jit_uni_extract_img_patches_kernel_f32<isa>::generate() {
...
//    int kh = jpp.kh;
    ...
    if (jpp.is_training || jpp.is_backward)
