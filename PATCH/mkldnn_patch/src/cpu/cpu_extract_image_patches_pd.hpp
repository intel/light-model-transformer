...
#ifndef CPU_extract_image_patches_PD_HPP
#define CPU_extract_image_patches_PD_HPP

#include <assert.h>

#include "c_types_map.hpp"
#include "extract_image_patches_pd.hpp"
...
inline data_type_t extract_image_patches_index_data_type(const extract_image_patches_desc_t *p) {
...
struct cpu_extract_image_patches_fwd_pd_t: public extract_image_patches_fwd_pd_t {
    using cpu_memory_pd_t = cpu_memory_t::pd_t;

    cpu_extract_image_patches_fwd_pd_t(engine_t *engine, const extract_image_patches_desc_t *adesc,
            const primitive_attr_t *attr, const extract_image_patches_fwd_pd_t *hint_fwd_pd)
        : extract_image_patches_fwd_pd_t(engine, adesc, attr, hint_fwd_pd)
        , src_pd_(engine_, &desc_.src_desc), dst_pd_(engine_, &desc_.dst_desc)
        , ws_pd_(engine_) {}
    virtual ~cpu_extract_image_patches_fwd_pd_t() {}
